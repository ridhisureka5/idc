      ...
      <section className="px-6 pb-24">
        ...
        >
          ...
          <div className="relative z-10">
            <Gem size={54} className="mx-auto text-[#5a2b14] mb-8" />
            ...
            <p className="text-[16px] md:text-[17px] leading-9 text-center text-[#6d5a50] max-w-4xl mx-auto">
              ...
              It ensures accurate gemstone authentication, grading, and ethical
              trade.
            </p>
          </div>
        </motion.div>
          ...
          {scienceCards.map((card, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden bg-white border border-[#eee3d8] rounded-[30px] p-8 shadow-[0_10px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(90,43,20,0.08)] transition-all duration-500"
              >
                <div className="absolute top-0 right-0 w-44 h-44 bg-[#c89a74]/10 blur-3xl rounded-full opacity-0 group-hover:opacity-100 transition duration-700" />

                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-[#f7f1eb] flex items-center justify-center mb-7">
                    <Icon size={32} className="text-[#5a2b14]" />
                  </div>
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 py-24 text-center">
            ...
            <p className="text-[16px] md:text-[18px] text-white/90 leading-8 max-w-3xl mx-auto mb-12">
              Contact us today for professional gemological services and
              gemstone certification with trusted expert analysis.
            </p>

            <div className="flex items-center justify-center gap-5 flex-wrap">
                <Link href="/contact" className="px-9 py-4 rounded-2xl bg-white text-[#4a1d0e] text-[15px] font-semibold hover:scale-105 hover:shadow-2xl transition duration-300">
                  Contact Us
                </Link>
             
<Link href="/services" className="px-9 py-4 rounded-2xl bg-white/15 border border-white/20 backdrop-blur-md text-white text-[15px] font-medium hover:bg-white/25 transition duration-300">
                  Our Services
                </Link>
