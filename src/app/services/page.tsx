          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-white border border-[#eee2d8] rounded-[26px] p-9 overflow-hidden transition-all duration-500 hover:shadow-[0_18px_50px_rgba(90,43,20,0.10)]"
              >
                {/* Brownish glow */}
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-[#f5efea] flex items-center justify-center mb-8 transition duration-500 group-hover:scale-110 group-hover:bg-[#f0e4da]">
                    <Icon size={26} className="text-[#5b2c16]" />
                  </div>
      ...
      <section className="py-24 px-6">
        ...
        >
          ...
          <p className="text-[16px] leading-8 text-[#6e5d54] max-w-3xl mx-auto mb-10">
            Submit your gemstones today and receive professional certification
            from our expert gemologists.
          </p>

          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Link href="/contact" className="px-8 py-3.5 rounded-xl bg-[#5b2c16] text-white text-[15px] font-medium hover:scale-105 hover:shadow-lg transition duration-300">
              Contact Us
            </Link>
            
<Link href="/services" className="px-8 py-3.5 rounded-xl border border-[#d9c6b8] text-[15px] font-medium hover:bg-[#f7f1ec] transition duration-300">
              View Services
            </Link>
